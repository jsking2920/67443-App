...
//  Based on: https://github.com/Peter-Schorn/SpotifyAPIExampleApp/blob/main/SpotifyAPIExampleApp/Views/SearchForTracksView.swift
//
...
struct SongSearchView: View {
		...
		var body: some View {
				...
				.navigationTitle("What are you feeling today...")
